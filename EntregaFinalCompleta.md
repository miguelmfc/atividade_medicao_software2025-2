...
* **Atributos de usabilidade percebida:** eficiência, eficácia e satisfação;
...
* **H1:** Em **São Paulo**, o aplicativo utilizado apresenta maiores funcionalidades, devido à complexidade e ao tamanho do sistema de transporte da cidade.
* **H2:** Em **Belo Horizonte**, avaliações negativas do **BHBus** concentram-se na área de UI/UX.
* **H3:**Aplicativos com menor nota média apresentam maior recorrência de reclamações relacionadas à navegação e clareza das rotas.
* **H4:** Avaliações com notas mais baixas estão  associadas à menção de problemas de interface e desempenho.
...
A coleta será realizada com bibliotecas como *google-play-scraper*. Os dados serão armazenados em CSV e desenvolvidos por etapas de limpeza, análise de sentimentos e categorização temática.
...
Esta seção apresenta as principais ameaças à validade do estudo, organizadas segundo a classificação clássica adotada em pesquisas empíricas. 
...
As avaliações analisadas são provenientes exclusivamente de usuários que optaram voluntariamente por registrar comentários na Google Play Store. Esse grupo pode  ser composto  por usuários com experiências extremas, positivas ou negativas, o que pode causar viés na caracterização geral da usabilidade percebida.
...
O construto de usabilidade é inferido a partir de avaliações espontâneas e não estruturadas, que não foram produzidas com base em um instrumento padronizado. Dessa forma, nem todas as áreas de eficácia, eficiência e satisfação são necessariamente atentidas nos comentários.
...
Essas imprecisões podem introduzir erro nos dados e afetar as comparações estatísticas e conclusões inferidas a partir dos resultados.
